...
## Project Structure
    ...
    ├── testappdeletion_dev_58802  # Django project configurations
...
1. Clone this repo and `cd testappdeletion_dev_58802`
...
2. Clone this repo and `cd testappdeletion_dev_58802`
